...
class CustomerController extends Controller
{
    ...
    {
        User::destroy($id);
        flash(__('front.Customer has been deleted successfully'))->success();
    ...
    public function ban($id) {
        ...
        if($user->banned == 1) {
            $user->banned = 0;
            flash(__('front.Customer UnBanned Successfully'))->success();
        } else {
            $user->banned = 1;
            flash(__('front.Customer Banned Successfully'))->success();
        }
