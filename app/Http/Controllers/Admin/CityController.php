...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        flash(__('front.City has been inserted successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(__('front.City has been updated successfully'))->success();
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        flash(__('front.City has been deleted successfully'))->success();
