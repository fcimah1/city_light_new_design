...
class FlashDealController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($flash_deal->save()){
            ...
            flash(__('front.Flash Deal has been inserted successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($flash_deal->save()){
            ...
            flash(__('front.Flash Deal has been updated successfully'))->success();
            return back();
        }
        else{
            flash(__('front.Something went wrong'))->error();
    ...
    public function destroy($id)
    {
        ...
        flash(__('front.FlashDeal has been deleted successfully'))->success();
        return redirect()->route('flash_deals.index');
    }
    ...
    public function update_status(Request $request)
    {
        ...
        if($flash_deal->save()){
            flash(__('front.Flash deal status updated successfully'))->success();
            return 1;
        }
        return 0;
    }
