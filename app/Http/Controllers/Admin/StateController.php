...
class StateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        flash(__('front.State has been inserted successfully'))->success();
        return back();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(__('front.State has been updated successfully'))->success();
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        flash(__('front.State has been deleted successfully'))->success();
