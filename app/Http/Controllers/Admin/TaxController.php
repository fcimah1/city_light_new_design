...
//        $pickup_point->address = $request->address;
        ...
        if ($tax->save()) {
            ...
            flash(__('front.Tax has been inserted successfully'))->success();
...
//        $language->code = $request->code;
        if($tax->save()){
            flash(__('front.Tax has been updated successfully'))->success();
            return redirect()->route('tax.index');
        }
        else{
            flash(__('front.Something went wrong'))->error();
...
//        $tax = Tax::findOrFail($id);
        ...
        if(Tax::destroy($id)){
            flash(__('front.Tax has been deleted successfully'))->success();
            return redirect()->route('tax.index');
        }
        else{
            flash(__('front.Something went wrong'))->error();
