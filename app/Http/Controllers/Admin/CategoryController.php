...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        flash(__('front.Category has been inserted successfully'))->success();
...
//   dd($categories);
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(__('front.Category has been updated successfully'))->success();
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        flash(__('front.Category has been deleted successfully'))->success();
        return redirect()->route('categories.index');
    }
