...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        if($request->has('permissions')){
            ...
            flash(__('front.Role has been inserted successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->has('permissions')){
            ...
            flash(__('front.Role has been updated successfully'))->success();
            return redirect()->route('roles.index');
        }
        flash(__('front.Something went wrong'))->error();
        return back();
    ...
    public function destroy($id)
    {
        ...
        Role::destroy($id);
        flash(__('front.Role has been deleted successfully'))->success();
        return redirect()->route('roles.index');
    }
}
