...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(count(Coupon::where('code', $request->coupon_code)->get()) > 0){
            flash(__('front.Coupon already exist for this coupon code'))->error();
            return back();
        }
        ...
        flash(__('front.Coupon has been saved successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(__('front.Coupon has been updated successfully'))->success();
        return redirect()->route('coupon.index');
    }
    ...
    {
        Coupon::destroy($id);
        flash(__('front.Coupon has been deleted successfully'))->success();
        return redirect()->route('coupon.index');
    }
