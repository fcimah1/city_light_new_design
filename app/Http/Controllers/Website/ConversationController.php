...
class ConversationController extends Controller
{
    ...
    public function index()
    {
        if (BusinessSetting::where('type', 'conversation_system')->first()->value == 1) {
            ...
            return view($this->design.'.user.conversations.index', compact('conversations'));
        }
        else {
    ...
    public function show($id)
    {
        ...
        $conversation->save();
        return view($this->design.'.user.conversations.show', compact('conversation'));
    }
    ...
    public function refresh(Request $request)
    {
        ...
        return view($this->design.'.partials.messages', compact('conversation'));
    }
