...
use App\Http\Controllers\Website\ClubPointController;
...
class OrderController extends Controller
{
        ...
        foreach ($seller_products as $seller_product) {
            ...
            foreach ($seller_product as $cartItem) {
                ...
                if ($product->digital != 1 && $cartItem['quantity'] > $product_stock->qty) {
                    flash(__('front.The requested quantity is not available for ') . $product->getTranslation('name'))->warning();
                    $order->delete();
    ...
    public function destroy($id)
    {
        ...
        if ($order != null) {
            ...
            $order->delete();
            flash(__('front.Order has been deleted successfully'))->success();
        } else {
    ...
    public function assign_delivery_boy(Request $request)
    {
        if (addon_is_activated('delivery_boy')) {
            ...
            if (env('MAIL_USERNAME') != null && get_setting('delivery_boy_mail_notification') == '1') {
                ...
                $array['subject'] = __('front.You are assigned to delivery an order. Order code') . ' - ' . $order->code;
