        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{__('front.Convert Point To Wallet')}}</h5>
                </div>
                <div class="card-body">
                    ...
                    <i class="fs-12"><b>{{ __('front.Note: You need to activate wallet option first before using club point addon.') }}</b></i>
                </div>
            </div>
        </div>
    </div>
