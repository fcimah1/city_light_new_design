...
$best_selers = Cache::remember('best_selers', 86400, function () {
    return \App\Models\Seller::where('verification_status', 1)
            ...
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span
                            class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ __('front.Best
                                                                                Sellers') }}</span>
                    </h3>
                    <a href="{{ route('sellers') }}"
                        class="ml-auto mr-0 btn btn-primary btn-sm shadow-md">{{ __('front.View All Sellers') }}</a>
                </div>
                                    ...
                                    <div class="col-8 border-left border-light">
                                        <div class="p-3 text-left">
                                            ...
                                            <a href="{{ route('shop.visit', $seller->user->shop->slug) }}"
                                                ...
                                                {{ __('front.Visit Store') }} <i class="las la-angle-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
