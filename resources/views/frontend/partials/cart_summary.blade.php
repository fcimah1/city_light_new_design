<div class="card border-0 shadow-sm rounded">
    <div class="card-header">
        <h3 class="fs-16 fw-600 mb-0">{{ __('front.Summary') }}</h3>
    ...
    <div class="card-body">
        ...
        <table class="table">
            <thead>
                <tr>
                    <th class="product-name">{{ __('front.Product') }}</th>
                    <th class="product-total text-right">{{ __('front.Total') }}</th>
                </tr>
            </thead>
            <tbody>
                @php
        ...
        <table class="table">
            ...
            <tfoot>
                ...
                <tr class="cart-total">
                    <th><span class="strong-600">{{ __('front.Total') }}</span></th>
                    <td class="text-right">
                    ...
                    <form class="" action="{{ route('checkout.remove_club_point') }}" method="POST"
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="submit"
                                    class="btn btn-primary">{{ __('front.Remove Redeem Point') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                {{-- @if (Auth::user()->point_balance > 0)
                    <div class="mt-3">
                        ...
                        <form class="" action="{{ route('checkout.apply_club_point') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="input-group">
                                <input type="text" class="form-control" name="point" placeholder="{{__('front.Enter club point here')}}" required>
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-primary">{{__('front.Redeem')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" id="coupon-remove"
                                    class="btn btn-primary">{{ __('front.Change Coupon') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form class="" id="apply-coupon-form" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="code"
                                ...
                                placeholder="{{ __('front.Have coupon code? Enter here') }}" required>
                            <div class="input-group-append">
                                <button type="button" id="coupon-apply"
                                    class="btn btn-primary">{{ __('front.Apply') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
