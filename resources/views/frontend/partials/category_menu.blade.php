<div class="aiz-category-menu bg-white rounded @if (Route::currentRouteName() == 'home') shadow-sm" @else shadow-lg"
    ...
    <div class="
    p-3 bg-soft-primary d-none d-lg-block rounded-top all-category position-relative ">
    <span class="fw-600 fs-16 mr-3">{{ __('front.categories') }}</span>
    <a href="#" class="text-reset">
        <span class="d-none d-lg-inline-block">{{ __('front.see all') }} ></span>
    </a>
</div>
<ul class="list-unstyled categories no-scrollbar py-2 mb-0">
