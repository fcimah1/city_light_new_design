                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('subcategories.store') }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="select2 form-control aiz-selectpicker @error('category_id')
                                        is-invalid
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="banner" class="selected-files @error('banner')
                                        is-invalid
                                    @enderror">
                                    @error('banner')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="icon" class="selected-files @error('icon')
                                        is-invalid
                                    @enderror">
                                    @error('icon')
                                        <span class="invalid-feedback" role="alert">
