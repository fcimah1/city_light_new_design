    ...
    <tbody>
        ...
        @foreach ($combinations as $key => $combination)
            ...
            <tr class="variant">
                ...
                <td>
                    <div class="input-group" data-toggle="aizuploader" data-type="image" style="height: 100px;width: 100px">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse') }}</div>
                        </div>
                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                        <input type="hidden" name="img_{{ $str }}"  value="{{($stock != null)?$stock->image:null}}"
class="selected-files">
                ...
                <td>
                    <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true" style="height: 100px;width: 100px">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse') }}</div>
                        </div>
                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                        <input type="hidden" name="photos_{{ $str }}"  value="{{($stock != null)?$stock->photos:null}}" class="selected-files">
                    </div>
