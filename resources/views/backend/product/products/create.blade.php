                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="show-hide-div">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Product Level')}} <span class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="0" value="0" step="1" placeholder="{{ translate('Product Level') }}" name="product_level" class="form-control" required>
                                </div>
                            </div>
