                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                                        ...
                                        <img src="{{ static_asset('assets/img/flags/' . $language->code . '.png') }}"
                                            height="11" class="mr-1" alt="flag image">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                    for="signinSrEmail">{{ translate('Gallery
                                                                    Images') }}</label>
                                <div class="col-md-8">
...
{{--                                        value="{{ implode(',', $choice_option->values) }}" data-on-change="update_sku"> --}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-from-label"
                                    for="start_date">{{ translate('Discount Date
                                                                    Range') }}</label>
                                <div class="col-sm-9">
    ...
    echo 'selected';
                            ...
                            <div id="show-hide-div">
                                ...
                                <div class="form-group row" id="quantity">
                                    <label class="col-lg-3 col-from-label">{{ translate('Product Level') }}</label>
                                    <div class="col-lg-6">
                                        <input type="number" lang="en"
                                            value="{{ $product->product_level }}" step="1"
                                            placeholder="{{ translate('Product Level') }}" name="product_level"
                                            class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" placeholder="{{ translate('External link') }}"
                                        ...
                                        class="form-control">
                                    <small
                                        class="text-muted">{{ translate('Leave it blank if you do not use external site
                                                                            link') }}</small>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                    for="signinSrEmail">{{ translate('PDF
                                                                    Specification') }}</label>
                                <div class="col-md-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                    for="signinSrEmail">{{ translate('Meta
                                                                    Images') }}</label>
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image"
                                        data-multiple="true">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse show" id="collapse_2">
                            @if (get_setting('shipping_type') == 'product_wise_shipping')
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-md-6 col-from-label">{{ translate('Is Product Quantity
                                                                        Mulitiply') }}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
        ...
        function add_more_customer_choice_option(i, name) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var trimmedName = name.trim(); // Trim leading and trailing white space
                    ...
                    <div class="form-group row">\
                        <div class="col-md-3">\
                            ...
                            <input type="text" class="form-control" name="choice[]" value="'+ trimmedName +'" placeholder="{{ translate('Choice Title') }}" readonly>\
                        </div>\
                        <div class="col-md-8">\
