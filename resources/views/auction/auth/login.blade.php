                            ...
                            <div class="mb-5 text-center">
                                ...
                                @else
                                    <img src="{{ static_asset('assets/img/logo.png') }}" class="mw-100 mb-4"
                                        height="40">
                                @endif
                                <h1 class="h3 text-primary mb-0">{{ __('front.Welcome to') }} {{ env('APP_NAME') }}</h1>
                                <p>{{ __('front.Login to your account.') }}</p>
                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="text-left">
                                            <label class="aiz-checkbox">
                                                ...
                                                <span>{{ __('front.Remember Me') }}</span>
                                    ...
                                    @if (env('MAIL_USERNAME') != null && env('MAIL_PASSWORD') != null)
                                        <div class="col-sm-6">
                                            <div class="text-right">
                                                <a href="{{ route('password.request') }}" class="text-reset fs-14"></a>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button class="btn btn-info btn-xs"
                                                        onclick="autoFill()">{{ __('front.Copy') }}</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
